...
export class ConstraintsComponent implements OnInit {
  ...
  //     let addLessonModel: AddConstraintModel = {

  //     }
  //     this.constraintService.add(addLessonModel).subscribe(() => {
  ...
  //   } else {
  //     console.log(this.constraint);
  //     let updateLessonModel: UpdateConstraintModel = {

  //     }
  //     let id = this.constraint.constraintId;
  //     this.constraintService.update(updateLessonModel, id).subscribe(() => {
